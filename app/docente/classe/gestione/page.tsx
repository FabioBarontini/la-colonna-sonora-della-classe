...
export default function Page(){return <main className="min-h-screen py-7 md:py-9"><div className="container">
  ...
  <div className="mt-8 flex flex-wrap items-end justify-between gap-5"><div><div className="eyebrow">Pannello amministratore</div><h1 className="mt-2 text-5xl font-black tracking-[-.05em]"><span className="gradient-text">Gestione classe</span></h1><p className="mt-3 max-w-2xl muted">Crea gli accessi, assegna i codici personali e controlla lo stato delle playlist.</p></div><div className="admin-badge"><Settings2 size={15}/> Area riservata</div></div>
  <GestioneClasse/>
